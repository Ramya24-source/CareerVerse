...
class ResumeApp:
    ...
    <style>
        /* Global page text */
        html, body, [class*="css"], p, .stMarkdown {
            color: white !important;
        }

        /* Optional: Make bold text & labels white */
        strong, label {
            color: white !important;
        }
                     /* Change titles and subheaders */
            h1, h2, h3, h4, h5, h6 {
                color: white !important;
            }
    </style>
""", unsafe_allow_html=True)
    ...
    "assets",
     "124852522.jpeg")
        ...
        st.markdown("""
            ...
            <style>
                     /* Global Black Background & White Font */
        body {
        ...
        # Hero Section
        st.markdown("""
                     <div style='background-color: #000000; padding: 20px; border-radius: 10px; margin: 10px 0; color: #FFFFFF;'>
    ...
    def render_analyzer(self):
        ...
        analyzer_tabs = st.tabs(["Standard Analyzer"])
            ...
            if uploaded_file:
                ...
                if analyze_standard:
                    ...
                    with col1:
                        ...
                        st.markdown("""
                                    <div style='background-color: #000000; padding: 15px; border-radius: 10px; margin: 10px 0; color: white;'>
                        <div class="feature-card">
                            <h2>Skills Match</h2>
                        """, unsafe_allow_html=True)
    ...
    def show_repo_notification(self):
        message = """
<div style="background-color: #ffffff;; border-radius: 10px; border: 1px solid #4b6cb7; padding: 10px; margin: 10px 0; color: white;">
