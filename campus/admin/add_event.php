...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === 0) {
        ...
        $error = "Please select an image for the event.";
    }

    if (empty($error)) {
        $query = "INSERT INTO events (category_id, title, description, event_date, registration_link, image)
                  VALUES ('$cat', '$title', '$desc', '$date', '$link', '$imgName')";
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li><a href="add_event.php" class="active"><i class="fas fa-calendar-plus"></i> <span>Add Event</span></a></li>
        ...
        <div class="content">
            ...
            <div class="form-container">
                <div class="form-header">
                    ...
                    <p>Fill in the details below to add a new campus event</p>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select id="category" name="category" class="form-control" required>
                                ...
                                <?php while($c = mysqli_fetch_assoc($cats)): ?>
                                    <option value="<?php echo $c['id']; ?>" <?php echo (isset($_POST['category']) && $_POST['category'] == $c['id']) ? 'selected' : ''; ?>>
